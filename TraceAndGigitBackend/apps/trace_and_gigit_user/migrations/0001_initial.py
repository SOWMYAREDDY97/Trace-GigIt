...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'trace_and_gigit_user_user', (
            ...
            ('mobile_no', self.gf('django.db.models.fields.CharField')(max_length=32, null=True)),
            ('mobile_no_verified', self.gf('django.db.models.fields.BooleanField')(default=False)),
    ...
    models = {
        ...
        u'trace_and_gigit_user.user': {
            ...
            'mobile_no': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'}),
